    ...
    <div class="container">
      <div class="columns push-top-5">
        ...
        <div class="column is-widescreen">
          ...
          <p>Thoro ("us", "we", or "our") operates the https://thoro.news website (hereinafter referred to as the "Service").</p>
          ...
          <ul>
            <li>
              ...
              <p>Service is the https://thoro.news website operated by Thoro</p>
            </li>
            <li>
          ...
          <p>Thoro uses the collected data for various purposes:</p>
          ...
          <p>Thoro will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
          ...
          <p>Thoro may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
          <ul>
            <li>- To comply with a legal obligation</li>
            <li>- To protect and defend the rights or property of Thoro</li>
          ...
          <ul>
          <li>By visiting this page on our website: https://thoro.news/faq</li>
          </ul-->
        </div>
      </div>
    </div>
